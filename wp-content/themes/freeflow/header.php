            ...
            <div class="container yellow-bg-div gx-0 terms-yellow-bg-div">
                ...
                <div class=" row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-12  terms-content-div">
                        ...
                        賽馬會「自主・流」身體律動計劃會盡力發放最新以及最準確的信息，但不對網站或網站上包含的信息、產品、服務或相關圖形的適用而負上任何責任。因此，對此類信息的任何依賴均由用戶自行承擔風險。<br>
                        <br>
                ...
                <div class=" row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-12  terms-content-div">
                        ...
                        <ul>
                            ...
                            <li><span class="orange">Cookie</span> 是網站放置在閣下的計算機、移動設備或任何其他設備上的小文件，其中包含閣下在該網站
                                的多種用途中的瀏覽歷史詳細信息。
                            </li>
                            ...
                            <li><span class="orange">使用數據</span> 是指自動收集的數據，無論是通過使用服務還是從服務基礎設施本身生成的(例如，頁面訪 問的持續時間)。
                            </li>
 ...
 -->
        ...
        <div id="page" class="site">
            ...
            <svg id="cursor" width="120" height="120">
                ...
                <circle cx="60" cy="60" r="20" fill="none" stroke="#605ed3" stroke-width="2" class="cursor-circle">
                </circle>
            </svg>
