        ...
        <div class="col-8">
            ...
            <div class="mt-4">
                我們希望能夠通過這個計劃去重塑女性對話！這是一個由香港賽馬會慈善信託基金捐助的試點項目，旨在透過身體律動去探討女性身份以及年輕女性在現今社會的意義。除了身體律動課和社工介入，我們還引入各種藝術和文化元素，與參加者有更多元化的互動，希望能擴闊她們的視野。請查看本網站<a
                    href="javascript:void(0);" class="orange-link">關於我們</a>頁面了解更多有關計劃、機構、合作夥伴的資訊！
            </div>
            ...
            <div class="mt-4">
                ...
                你可通過各種方式參與這個計劃！如果你是教育工作者、創作者或藝術家，請查看本網站<a href="javascript:void(0);"
...
<div class="container yellow-bg-div gx-0 mt-120px">
    ...
    <div class="row">
        ...
        <div class="col-6 mb-4">
            ...
            <a href=""><img class="w-100 album-a"
